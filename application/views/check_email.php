  ...
  <body class="hold-transition register-page">
    ...
    <div class="register-logo">
      ...
      <div class="register-box-body">
        ...
        <form action="<?php echo base_url();?>index.php/register/check_email" method="post">
          ...
          <div class="form-group has-feedback">
            ...
            <input type="email" name="user_email" class="form-control" placeholder="(请填写注册时的邮箱，方便找回密码)">
