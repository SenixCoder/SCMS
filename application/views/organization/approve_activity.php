	...
	<div class="box-body">
		...
		<tbody>
			...
			?>
				...
				<td>
				<?php if($row->add_time == NULL && $this->session->userdata('isAdmin') == 8){?>
					<a href="<?php echo site_url('organization/approve_activity_time');?>/<?php echo $row->id;?>" >同意申请</a>
				<?php } else if($row->add_time != NULL) {;?>
					已批准
				<?php } else {?>
					未批准
				<?php }?>
